...
$stmt->bind_param("ssssssssssssss", $_POST['nome'], $_POST['cognome'],$_POST['telefono'],$_POST['mail'],$_POST['data_nascita'],$_POST['tessera'],$_POST['scadenza_carta'],$_POST['codice_carta'],$_POST['cvv_carta'],$_POST['via'],$_POST['citta'],$_POST['user'], $_POST['psw']);
if ($stmt->execute()){
